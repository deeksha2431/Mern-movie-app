...
import FavoriteBorderOutlinedIcon from "@mui/icons-material/Verified";
              ...
              <Box sx={{
                ...
                <Stack spacing={5}>
                  ...
                  <LoadingButton
                      ...
                      size="large"
                      startIcon={isFavorite ? <FavoriteBorderOutlinedIcon /> : <PlusIcon />}
                      loadingPosition="center"
                      loading={onRequest}
                      onClick={onFavoriteClick}
                    >{isFavorite ? "Remove From List" : "Add To List"} </LoadingButton>
                    <Button
                      variant="contained"
